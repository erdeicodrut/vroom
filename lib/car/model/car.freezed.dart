...
abstract class $CarCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, AssetGenImage image});
}
...
class _$CarImpl implements _Car {
  const _$CarImpl({required this.name, required this.image});
  ...
  @override
  String toString() {
    return 'Car(name: $name, image: $image)';
  }
...
abstract class _Car implements Car {
  const factory _Car(
      ...
      required final AssetGenImage image}) = _$CarImpl;
